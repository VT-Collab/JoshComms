...
class GUI_Interface(object):
    def __init__(self):
        ...
        # X_Y Uncertainty
        self.myLabel1 = Label(self.root, text = "Cup", font=(font, 40))
        ...
        self.myLabel2 = Label(self.root, text = "Mug", font=(font, 40))
        ...
        self.myLabel3 = Label(self.root, text = "Bowl", font=(font, 40))
