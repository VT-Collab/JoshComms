...
class SimpleEnv():
    ...
    def __init__(self, visualize=False):
        ...
        self.cup1.load()
        self.cup1_position = [0.65, 0.10, 0.1]
        self.cup1_poslist = [[0.65, 0.10, 0.1]]
        ...
        self.mug.load()
        self.mug_position = [0.5, -0.25, 0.1]
        self.mug_poslist = [[0.5, -0.25, 0.1]]
        ...
        self.salt.load()
        self.salt_position = [0.45, 0.275, 0.1]
        self.salt_poslist = [[0.45, 0.275, 0.1]]
