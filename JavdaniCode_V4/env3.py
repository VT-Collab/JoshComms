...
class SimpleEnv():
    ...
    def __init__(self, visualize=False):
        ...
        self.cup1.load()
        self.cup1_position = [0.67, -0.050, 0.07]
        self.cup1_poslist = [[0.67, -0.050, 0.07]]
        ...
        self.mug.load()
        self.mug_position = [0.57, 0.2, 0.1]
        self.mug_poslist = [[0.57, 0.2, 0.1]]
        ...
        self.salt.load()
        self.salt_position = [0.5, 0.35, 0.1]
        self.salt_poslist = [[0.5, 0.35, 0.1]]
