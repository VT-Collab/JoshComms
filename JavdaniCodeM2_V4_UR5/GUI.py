...
class GUI_Interface(object):
    def __init__(self):
        ...
        # X_Y Uncertainty
        self.myLabel1 = Label(self.root, text = "Can", font=(font, 80))
        ...
        self.myLabel2 = Label(self.root, text = "Mug", font=(font, 80))
        ...
        self.myLabel3 = Label(self.root, text = "Block", font=(font, 80))
