...
if __name__ == "__main__":
  ...
  for i in range(1):
    ...
    #print("HOT POTATO")
    ada_handler = AdaHandler(env, goals, goal_objects,user=200,demo=3) #goal objects is env objects, goals are GOAL object made from env objects
    ada_handler.execute_policy(direct_teleop_only = False, fix_magnitude_user_command=True,w_comms=True,algo_enabled = True)
