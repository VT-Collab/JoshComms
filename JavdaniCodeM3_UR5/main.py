...
if __name__ == "__main__":
  ...
  for i in range(1):
    ...
    #print("HOT POTATO")
    ada_handler = AdaHandler(env, goals, goal_objects,user=200,demo=1,algo_enabled = True) #goal objects is env objects, goals are GOAL object made from env objects
