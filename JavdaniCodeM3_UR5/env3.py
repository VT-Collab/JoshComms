...
class SimpleEnv():
    ...
    def init_objects(self):
        ...
        self.salt.load()
        self.salt_position = [-0.784, -0.1825, 0.25]
        self.salt_poslist = [[-0.784, -0.1825, 0.25]]
        ...
        self.pepper.load()
        self.pepper_position = [-0.634, -0.260, 0.255]
        self.pepper_poslist = [[-0.634, -0.260, 0.255]]
        ...
        self.plate.load()
        self.plate_position = [-0.555, -0.17, 0.3]
        self.plate_poslist = [[-0.555, 0.17, 0.3]]
        ...
        self.fork.load()
        self.fork_position = [-0.321, -0.198, 0.325]
        self.fork_poslist = [[-0.321, -0.198, 0.325]]
        ...
        self.spoon.load()
        self.spoon_position = [-0.445, -0.288, 0.325]
        self.spoon_poslist = [[-0.445, -0.288, 0.325]]
        ...
        self.fork2.load()
        self.fork2_position = [-0.365, 0.195, 0.28]
        self.fork2_poslist = [[-0.365, 0.195, 0.28]]
        ...
        self.spoon2.load()
        self.spoon2_position = [-0.73, 0.205, 0.28]
        self.spoon2_poslist = [[-0.73, 0.205, 0.28]]
        ...
        self.cup1.load()
        self.cup1_position = [-0.315, -0.035, 0.3]
        self.cup1_poslist = [[-0.315, -0.035, 0.3]]
        ...
        self.mug.load()
        self.mug_position = [-0.65,-0.055, 0.3]
        self.mug_poslist = [[-0.65,-0.055, 0.3]]
