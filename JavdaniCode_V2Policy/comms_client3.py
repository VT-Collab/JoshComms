...
def main():
    ...
    while True:
        ...
        if len(msg)>1:
            ...
            #print(state_str,"state_str")
            log_goal_distribution= np.array(list(map(float, (msg.split(",")) [-3:])),dtype = DoubleVar)
            ...
            max_prob_goal_ind = np.argmax(log_goal_distribution)
            goal_distribution_sorted = np.sort(log_goal_distribution)
            ...
            GUI_1.textbox1.delete(0, END)
            GUI_1.textbox1.insert(0, log_goal_distribution[0])
            
            GUI_1.textbox2.delete(0, END)
            GUI_1.textbox2.insert(0, log_goal_distribution[1])

            GUI_1.textbox3.delete(0, END)
            GUI_1.textbox3.insert(0,log_goal_distribution[2])
