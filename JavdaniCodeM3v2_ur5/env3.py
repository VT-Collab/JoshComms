...
class SimpleEnv():
    ...
    def init_objects(self):
        ...
        self.plate.load()
        self.plate_position = [-0.555, -0.17, 0.25]
        self.plate_poslist = [[-0.555, 0.17, 0.25]]
        ...
        self.fork.load()
        self.fork_position = [-0.321, -0.198, 0.25]
        self.fork_poslist = [[-0.321, -0.198, 0.25]]
        ...
        self.spoon.load()
        self.spoon_position = [-0.445, -0.288, 0.25]
        self.spoon_poslist = [[-0.445, -0.288, 0.25]]
        ...
        self.fork2.load()
        self.fork2_position = [-0.365, 0.195, 0.25]
        self.fork2_poslist = [[-0.365, 0.195, 0.25]]
        ...
        self.spoon2.load()
        self.spoon2_position = [-0.73, 0.205, 0.25]
        self.spoon2_poslist = [[-0.73, 0.205, 0.25]]
