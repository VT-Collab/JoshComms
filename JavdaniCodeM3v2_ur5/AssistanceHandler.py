...
class AdaHandler:
	def __init__(self, env, goals, goal_objects, goal_object_poses=None,user=44,demo=0,algo_enabled = False):
		self.env = env
		  #self.robot = robot
		self.goals = goals
		...
		self.robot_policy = PrimaryPolicy(self.goals,algo_enabled)
		self.algo_enabled = algo_enabled
		self.user = user
		self.demo = demo
	...
	def execute_policy(self, direct_teleop_only=False, blend_only=True, fix_magnitude_user_command=True, w_comms = True):
		...
		if (w_comms == True):
			...
			GUI_1.fg = '#ff0000'
			GUI_1.textbox1 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
			GUI_1.textbox1.grid(row = 1, column = 0,  pady = 50, padx = 100)  

			GUI_1.textbox2 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
			GUI_1.textbox2.grid(row = 1, column = 1,   pady = 50, padx = 100) 

			GUI_1.textbox3 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
			GUI_1.textbox3.grid(row = 1, column = 2,   pady = 50, padx = 100)  

			GUI_1.textbox4 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
			GUI_1.textbox4.grid(row = 3, column = 0,   pady = 50, padx = 100)     

			GUI_1.textbox5 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
			GUI_1.textbox5.grid(row = 3, column = 1,  pady = 50, padx = 100) 

			GUI_1.textbox6 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
			GUI_1.textbox6.grid(row = 3, column = 2,  pady = 50, padx = 100) 

			GUI_1.textbox7 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
			GUI_1.textbox7.grid(row = 5, column = 0,  pady = 50, padx = 100)      

			GUI_1.textbox8 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
			GUI_1.textbox8.grid(row = 5, column = 1,   pady = 50, padx = 100) 

			GUI_1.textbox9 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
			GUI_1.textbox9.grid(row = 5, column = 2,  pady = 50, padx = 100) 
			Tracker = "Tired"
			oldmax = 9001
			GUI_1.root.update()
		...
		if not direct_teleop_only and fix_magnitude_user_command:
			for goal_policy in self.robot_policy.assist_policy.goal_assist_policies:
				for target_policy in goal_policy.target_assist_policies:
					...
					target_policy.set_observation(self.algo_enabled)
					#print(target_policy.observ)
		...
		while not rospy.is_shutdown():
			...
			if Begin_Switch:
						...
						if self.robot_policy.blend_confidence_function_prob_diff(goal_distribution):
							if oldmax != max_prob_goal_ind:
								...
								if max_prob_goal_ind == 0:
									GUI_1.textbox1 = Entry(GUI_1.root, width = 4, bg = "white", fg='#00ff00', borderwidth = 3, font=("Palatino Linotype", 60))
								else:
									GUI_1.textbox1 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
								#GUI_1.textbox1.grid(row = 1, column = 0,  pady = 50, padx = 100)

								if max_prob_goal_ind == 1:
									GUI_1.textbox2 = Entry(GUI_1.root, width = 4, bg = "white", fg='#00ff00', borderwidth = 3, font=("Palatino Linotype", 60))
								else:
									GUI_1.textbox2 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
								#GUI_1.textbox2.grid(row = 1, column = 1,  pady = 50, padx = 100)
								
								if max_prob_goal_ind == 2:
									GUI_1.textbox3 = Entry(GUI_1.root, width = 4, bg = "white", fg='#00ff00', borderwidth = 3, font=("Palatino Linotype", 60))
								else:
									GUI_1.textbox3 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
								#GUI_1.textbox3.grid(row = 1, column = 2,  pady = 50, padx = 100)
								...
								if max_prob_goal_ind == 3:
									GUI_1.textbox4 = Entry(GUI_1.root, width = 4, bg = "white", fg='#00ff00', borderwidth = 3, font=("Palatino Linotype", 60))
								else:
									GUI_1.textbox4 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
								#GUI_1.textbox4.grid(row = 3, column = 0,  pady = 50, padx = 100)

								if max_prob_goal_ind == 4:
									GUI_1.textbox5 = Entry(GUI_1.root, width = 4, bg = "white", fg='#00ff00', borderwidth = 3, font=("Palatino Linotype", 60))
								else:
									GUI_1.textbox5 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
								#GUI_1.textbox5.grid(row = 3, column = 1,  pady = 50, padx = 100)

								if max_prob_goal_ind == 5:
									GUI_1.textbox6 = Entry(GUI_1.root, width = 4, bg = "white", fg='#00ff00', borderwidth = 3, font=("Palatino Linotype", 60))
								else:
									GUI_1.textbox6 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
								#GUI_1.textbox6.grid(row = 3, column = 2,  pady = 50, padx = 100)
								...
								if max_prob_goal_ind == 6:
									GUI_1.textbox7 = Entry(GUI_1.root, width = 4, bg = "white", fg='#00ff00', borderwidth = 3, font=("Palatino Linotype", 60))
								else:
									GUI_1.textbox7 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
								#GUI_1.textbox7.grid(row = 5, column = 0,  pady = 50, padx = 100)

								if max_prob_goal_ind == 7:
									GUI_1.textbox8 = Entry(GUI_1.root, width = 4, bg = "white", fg='#00ff00', borderwidth = 3, font=("Palatino Linotype", 60))
								else:
									GUI_1.textbox8 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
								#GUI_1.textbox8.grid(row = 5, column = 1, pady = 50, padx = 100)

								if max_prob_goal_ind == 8:
									GUI_1.textbox9 = Entry(GUI_1.root, width = 4, bg = "white", fg='#00ff00', borderwidth = 3, font=("Palatino Linotype", 60))
								else:
									GUI_1.textbox9 = Entry(GUI_1.root, width = 4, bg = "white", fg=GUI_1.fg, borderwidth = 3, font=("Palatino Linotype", 60))
								#GUI_1.textbox9.grid(row = 5, column = 2,  pady = 50, padx = 100)
				...
				GoalList.append(goal_distribution)
				...
				if STOP:
					...
					db = {'TotalTime':TimeStepList,'State':StateList,'UserAction':UserActionList,'AutoAction':AutoActionList,'InputList':InputList,"GoalList":GoalList}
