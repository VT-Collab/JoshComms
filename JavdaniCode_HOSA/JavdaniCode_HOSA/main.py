...
if __name__ == "__main__":
  ...
  #user_string ="user" + args.user + "_demo" +args.demo 
  for i in range(1):
    #goals, goal_objects0 = Initialize_Goals(env, robot, randomize_goal_init=False)
    ...
    ada_handler.execute_policy(direct_teleop_only=False, fix_magnitude_user_command=False,w_comms=True,confVibe= True,user = args.user,demo=args.demo)
    #TODO:
    #Change GUI  element
    #Add Data Tracker
